...
| `use-agent-cli` | Use Codex CLI, Cursor Agent, Claude Code, or opencode as delegated child agents with CLI-specific references and model/effort configuration / 将 Codex CLI、Cursor Agent、Claude Code 或 opencode 作为子 agent 调用，包含按 CLI 拆分的参考和 model/effort 配置 | Original | MIT |
