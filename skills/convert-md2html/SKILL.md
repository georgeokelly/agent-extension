...
description: >-
  ...
  or custom scripts; also covers web template systems like Jekyll and Hugo.
  Use when asked to "convert markdown to html", "transform md to html",
...
> **Attribution**: Adapted from [awesome-copilot/markdown-to-html](https://github.com/github/awesome-copilot/tree/main/skills/markdown-to-html) by GitHub, licensed under MIT.
> Modified by georgel for cross-tool integration with agent-rules/agent-toolkit.
...
| `-s, --string ` | Parse string instead of file |
...
| Option | Description |
|--------|-------------|
| `-f, --from ` | Input format (markdown, html, latex, etc.) |
| `-t, --to ` | Output format (html, latex, pdf, docx, etc.) |
| `-s, --standalone` | Produce standalone document with header/footer |
| `-o, --output ` | Output file (inferred from extension) |
...
| Command | Description |
|---------|-------------|
| `jekyll new ` | Create new Jekyll site |
...
| Command | Description |
|---------|-------------|
| `hugo new site ` | Create new Hugo site |
| `hugo new content ` | Create new content file |
...
| `-p, --port ` | Port number (default: 1313) |
| `--liveReloadPort ` | Live reload port |
...
- Extensibility: <https://pandoc.org/lua-filters.html>
...
- Advanced configuration: <https://pkg.go.dev/github.com/gomarkdown/markdown/parser>
- Markdown processing: <https://pkg.go.dev/github.com/gomarkdown/markdown/html>
...
- Configuration options: <https://jekyllrb.com/docs/configuration/>
...
- All Settings: <https://gohugo.io/getting-started/configuration/#all-configuration-settings>
